  ...
  (
    ...
    return (
      <aside
        ...
        className={cn(
          "group peer hidden h-screen shrink-0 border-r bg-sidebar text-sidebar-foreground md:flex md:flex-col",
          "overflow-hidden sticky top-0",
          isCollapsed && collapsible === "offcanvas" && "border-0",
          className
        )}
        data-state={state}
        ...
        {...props}
      >
        <div style={{ minWidth: SIDEBAR_WIDTH }} className="flex h-full flex-col">
          {children}
        </div>
      </aside>
    )
