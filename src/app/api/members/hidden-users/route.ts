...
const META_TYPE = 'members_hidden';
...
/**
 * GET - Check which users are hidden from members page
...
export async function GET(request: Request) {
  try {
    ...
    console.error('[members/hidden-users] Error fetching:', error);
...
export async function POST(request: Request) {
  try {
    ...
    console.error('[members/hidden-users] Error adding event:', error);
